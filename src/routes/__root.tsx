    ...
    head: () => ({
      meta: [
        ...
        { title: "ProductPulse AI — Autonomous Product Decision Room" },
        {
          name: "description",
          content:
            "Detect product metric anomalies, run AI investigations and approve product actions with human oversight.",
        },
        {
          property: "og:title",
          content: "ProductPulse AI — Autonomous Product Decision Room",
        },
        {
      ...
      links: [
        ...
        {
          rel: "icon",
          href: "/productpulse-icon.svg?v=1",
          type: "image/svg+xml",
        },
      ],
    }),
